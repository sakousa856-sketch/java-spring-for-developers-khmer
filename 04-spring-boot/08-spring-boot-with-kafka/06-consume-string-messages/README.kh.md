...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../05-publish-string-messages/README.kh.md) | [មេរៀនបន្ទាប់ →](../07-create-configure-topics/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការផ្ញើ String Messages ទៅកាន់ Kafka (Publishing String Messages)](../05-publish-string-messages/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការបង្កើត និងកំណត់រចនាសម្ព័ន្ធ Topics ដោយស្វ័យប្រវត្តិ (Programmatic Topic Configuration) →](../07-create-configure-topics/README.kh.md) |
