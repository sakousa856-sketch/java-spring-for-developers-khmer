...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../08-kafka-elasticsearch-grafana/README.kh.md) | [មេរៀនបន្ទាប់ →](../../09-spring-boot-with-aop/01-aop-introduction/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការតាមដាន Kafka Metrics ជាមួយ Elasticsearch និង Grafana (Kafka Observability)](../08-kafka-elasticsearch-grafana/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការគ្រប់គ្រង Cross-Cutting Concerns ជាមួយ Aspect-Oriented Programming (AOP) →](../../09-spring-boot-with-aop/01-aop-introduction/README.kh.md) |
