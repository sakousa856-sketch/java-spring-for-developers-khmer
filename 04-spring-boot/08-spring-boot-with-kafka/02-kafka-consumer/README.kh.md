...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../01-kafka-producer/README.kh.md) | [មេរៀនបន្ទាប់ →](../03-publish-json-messages/README.kh.md)
...
| :--- | :---: | :--- |
| [← ស្ថាបត្យកម្ម Event-Driven Messaging និង Kafka Producer ជាមួយ KafkaTemplate](../01-kafka-producer/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការផ្ញើ JSON Messages តាមរយៈ Kafka (Publishing JSON Messages) →](../03-publish-json-messages/README.kh.md) |
