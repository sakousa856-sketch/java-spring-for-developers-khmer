...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../01-spring-boot-architecture/README.kh.md) | [មេរៀនបន្ទាប់ →](../03-auto-configuration/README.kh.md)
...
| :--- | :---: | :--- |
| [← ស្ថាបត្យកម្មខាងក្នុងរបស់ Spring Boot (Spring Boot Architecture)](../01-spring-boot-architecture/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [យន្តការកំណត់រចនាសម្ព័ន្ធស្វ័យប្រវត្តិ (Auto-Configuration Deep Dive) →](../03-auto-configuration/README.kh.md) |
