...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../02-spring-boot-annotations/README.kh.md) | [មេរៀនបន្ទាប់ →](../04-dependency-management/README.kh.md)
...
| :--- | :---: | :--- |
| [← Spring Boot Annotations សំខាន់ៗ (Core Spring Boot Annotations)](../02-spring-boot-annotations/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការគ្រប់គ្រង Starter Dependencies (Dependency Management) →](../04-dependency-management/README.kh.md) |
