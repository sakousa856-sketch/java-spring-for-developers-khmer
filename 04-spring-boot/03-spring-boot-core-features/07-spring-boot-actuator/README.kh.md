...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../06-yaml-configuration/README.kh.md) | [មេរៀនបន្ទាប់ →](../08-spring-boot-devtools/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការកំណត់រចនាសម្ព័ន្ធជាមួយ YAML (YAML Configuration in Spring Boot)](../06-yaml-configuration/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [បង្កើនល្បឿនអភិវឌ្ឍន៍ជាមួយ Spring Boot DevTools (Developer Tools) →](../08-spring-boot-devtools/README.kh.md) |
