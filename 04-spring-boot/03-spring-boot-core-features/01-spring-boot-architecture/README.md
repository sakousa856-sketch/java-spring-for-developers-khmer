...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.md) | [← មេរៀនមុន](../../02-spring-core-concept/10-build-tools-maven-gradle/README.md) | [មេរៀនបន្ទាប់ →](../02-spring-boot-annotations/README.md)
...
| :--- | :---: | :--- |
| [← ការប្រើប្រាស់ Build Tools ជាមួយ Spring (Maven & Gradle)](../../02-spring-core-concept/10-build-tools-maven-gradle/README.md) | [📚 បញ្ជីមេរៀន Module](../README.md) | [Spring Boot Annotations សំខាន់ៗ (Core Spring Boot Annotations) →](../02-spring-boot-annotations/README.md) |
