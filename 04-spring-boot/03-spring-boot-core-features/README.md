...
```mermaid
flowchart TD
    L1["01. Spring Boot Architecture"] --> L2["02. Spring Boot Core Annotations"]
    L2["02. Spring Boot Core Annotations"] --> L3["03. Auto-Configuration Deep Dive"]
    L3["03. Auto-Configuration Deep Dive"] --> L4["04. Dependency Management & Starters"]
    L4["04. Dependency Management & Starters"] --> L5["05. Application Properties Configuration"]
