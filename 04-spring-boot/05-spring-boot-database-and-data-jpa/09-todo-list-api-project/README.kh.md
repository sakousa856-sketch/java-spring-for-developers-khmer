...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../08-crud-operations-jpa/README.kh.md) | [មេរៀនបន្ទាប់ →](../../06-advanced-spring-boot-features/01-task-scheduling/README.kh.md)
...
| :--- | :---: | :--- |
| [← ប្រតិបត្តិការ CRUD ពេញលេញជាមួយ Spring Data JPA (Full CRUD Operations)](../08-crud-operations-jpa/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការដំណើរការការងារស្វ័យប្រវត្តិតាមកាលកំណត់ (@Scheduled) និងអសមកាលកម្ម (@Async) →](../../06-advanced-spring-boot-features/01-task-scheduling/README.kh.md) |
