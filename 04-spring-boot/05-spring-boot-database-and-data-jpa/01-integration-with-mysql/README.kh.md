...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../../04-spring-boot-with-rest-api/11-validation/README.kh.md) | [មេរៀនបន្ទាប់ →](../02-integration-with-postgresql/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការផ្ទៀងផ្ទាត់ទិន្នន័យ (Input Validation) ជាមួយ Jakarta Bean Validation](../../04-spring-boot-with-rest-api/11-validation/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការភ្ជាប់ Spring Boot ជាមួយ PostgreSQL (Integration with PostgreSQL) →](../02-integration-with-postgresql/README.kh.md) |
