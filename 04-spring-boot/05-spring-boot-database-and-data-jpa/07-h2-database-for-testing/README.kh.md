...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../06-crudrepository-vs-jparepository/README.kh.md) | [មេរៀនបន្ទាប់ →](../08-crud-operations-jpa/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការប្រៀបធៀប Repositories: CrudRepository vs JpaRepository](../06-crudrepository-vs-jparepository/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ប្រតិបត្តិការ CRUD ពេញលេញជាមួយ Spring Data JPA (Full CRUD Operations) →](../08-crud-operations-jpa/README.kh.md) |
