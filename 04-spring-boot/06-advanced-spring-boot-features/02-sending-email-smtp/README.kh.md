...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../01-task-scheduling/README.kh.md) | [មេរៀនបន្ទាប់ →](../03-file-handling-upload/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការដំណើរការការងារស្វ័យប្រវត្តិតាមកាលកំណត់ (@Scheduled) និងអសមកាលកម្ម (@Async)](../01-task-scheduling/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការគ្រប់គ្រង និង Upload File ក្នុង Spring Boot (File Handling & Multipart Upload) →](../03-file-handling-upload/README.kh.md) |
