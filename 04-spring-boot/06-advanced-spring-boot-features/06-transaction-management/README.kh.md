...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../05-caching-providers-redis/README.kh.md) | [មេរៀនបន្ទាប់ →](../07-dto-mapping/README.kh.md)
...
| :--- | :---: | :--- |
| [← Caching Providers និង Redis Integration (Spring Boot Caching with Redis)](../05-caching-providers-redis/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការបម្លែងទិន្នន័យ DTO ជាមួយ MapStruct និង ModelMapper (DTO Mapping Patterns) →](../07-dto-mapping/README.kh.md) |
