...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../03-file-handling-upload/README.kh.md) | [មេរៀនបន្ទាប់ →](../05-caching-providers-redis/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការគ្រប់គ្រង និង Upload File ក្នុង Spring Boot (File Handling & Multipart Upload)](../03-file-handling-upload/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [Caching Providers និង Redis Integration (Spring Boot Caching with Redis) →](../05-caching-providers-redis/README.kh.md) |
