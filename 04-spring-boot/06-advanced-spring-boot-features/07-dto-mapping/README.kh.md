...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../06-transaction-management/README.kh.md) | [មេរៀនបន្ទាប់ →](../../07-microservices-with-spring-boot/01-microservices-step-by-step-guide/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការគ្រប់គ្រង Transaction ជាមួយ @Transactional (Declarative Transaction Management)](../06-transaction-management/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [មគ្គុទ្ទេសក៍បង្កើត Microservices មួយជំហានម្តងៗ (Microservices Step-by-Step Guide) →](../../07-microservices-with-spring-boot/01-microservices-step-by-step-guide/README.kh.md) |
