...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../../09-spring-boot-with-aop/09-aop-vs-aspectj/README.kh.md) | [មេរៀនបន្ទាប់ →](../02-testing-with-mockito/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការប្រៀបធៀប Spring AOP និង AspectJ (Spring AOP vs AspectJ)](../../09-spring-boot-with-aop/09-aop-vs-aspectj/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការធ្វើ Unit Testing ជាមួយ Mockito (Unit Testing with Mockito) →](../02-testing-with-mockito/README.kh.md) |
