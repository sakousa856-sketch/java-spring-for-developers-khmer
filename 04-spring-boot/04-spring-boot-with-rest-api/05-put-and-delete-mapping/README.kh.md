...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../04-get-and-post-mapping/README.kh.md) | [មេរៀនបន្ទាប់ →](../06-pathvariable-and-requestparam/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការប្រើប្រាស់ @GetMapping និង @PostMapping (Mastering @GetMapping & @PostMapping)](../04-get-and-post-mapping/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការគ្រប់គ្រងទិន្នន័យ Input ជាមួយ @PathVariable និង @RequestParam →](../06-pathvariable-and-requestparam/README.kh.md) |
