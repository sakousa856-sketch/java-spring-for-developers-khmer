...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../10-exception-handling/README.kh.md) | [មេរៀនបន្ទាប់ →](../../05-spring-boot-database-and-data-jpa/01-integration-with-mysql/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការគ្រប់គ្រង Exception ជាសកល (Global Exception Handling) ជាមួយ @RestControllerAdvice](../10-exception-handling/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការតភ្ជាប់ Spring Boot ជាមួយ MySQL Database →](../../05-spring-boot-database-and-data-jpa/01-integration-with-mysql/README.kh.md) |
