...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../02-rest-controller/README.kh.md) | [មេរៀនបន្ទាប់ →](../04-get-and-post-mapping/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការបង្កើត REST Controller ជាមួយ @RestController](../02-rest-controller/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការប្រើប្រាស់ @GetMapping និង @PostMapping (Mastering @GetMapping & @PostMapping) →](../04-get-and-post-mapping/README.kh.md) |
