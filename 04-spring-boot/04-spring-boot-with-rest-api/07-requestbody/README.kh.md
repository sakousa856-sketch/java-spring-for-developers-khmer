...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../06-pathvariable-and-requestparam/README.kh.md) | [មេរៀនបន្ទាប់ →](../08-build-rest-api-example/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការគ្រប់គ្រងទិន្នន័យ Input ជាមួយ @PathVariable និង @RequestParam](../06-pathvariable-and-requestparam/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [បង្កើត Complete REST API Example មួយពេញលេញ (Building a Complete RESTful API) →](../08-build-rest-api-example/README.kh.md) |
