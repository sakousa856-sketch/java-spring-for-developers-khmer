...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.md) | [← មេរៀនមុន](../../03-spring-boot-core-features/08-spring-boot-devtools/README.md) | [មេរៀនបន្ទាប់ →](../02-rest-controller/README.md)
...
4. **Uniform Interface**: ស្តង់ដាររួមតែមួយសម្រាប់ទំនាក់ទំនង ដោយប្រើ HTTP Methods (GET, POST, PUT, DELETE), Resource URIs, និង Data Representations (JSON/XML)។
...
| :--- | :---: | :--- |
| [← បង្កើនល្បឿនអភិវឌ្ឍន៍ជាមួយ Spring Boot DevTools (Developer Tools)](../../03-spring-boot-core-features/08-spring-boot-devtools/README.md) | [📚 បញ្ជីមេរៀន Module](../README.md) | [ការបង្កើត REST Controller ជាមួយ @RestController →](../02-rest-controller/README.md) |
