...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../03-request-mapping/README.kh.md) | [មេរៀនបន្ទាប់ →](../05-put-and-delete-mapping/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការប្រើប្រាស់ @RequestMapping (Deep Dive into @RequestMapping)](../03-request-mapping/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការប្រើប្រាស់ @PutMapping និង @DeleteMapping (Working with @PutMapping & @DeleteMapping) →](../05-put-and-delete-mapping/README.kh.md) |
