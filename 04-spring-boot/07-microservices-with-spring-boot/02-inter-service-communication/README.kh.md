...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../01-microservices-step-by-step-guide/README.kh.md) | [មេរៀនបន្ទាប់ →](../03-deploy-aws-elastic-beanstalk/README.kh.md)
...
| :--- | :---: | :--- |
| [← មគ្គុទ្ទេសក៍បង្កើត Microservices មួយជំហានម្តងៗ (Microservices Step-by-Step Guide)](../01-microservices-step-by-step-guide/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ការ Deploy Spring Boot ទៅកាន់ AWS Elastic Beanstalk (Deploying to AWS) →](../03-deploy-aws-elastic-beanstalk/README.kh.md) |
