...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.md) | [← មេរៀនមុន](../../06-advanced-spring-boot-features/07-dto-mapping/README.md) | [មេរៀនបន្ទាប់ →](../02-inter-service-communication/README.md)  
...
| :--- | :---: | :--- |
| [← ការបម្លែងទិន្នន័យ DTO ជាមួយ MapStruct និង ModelMapper](../../06-advanced-spring-boot-features/07-dto-mapping/README.md) | [📚 បញ្ជីមេរៀន Module](../README.md) | [ការប្រាស្រ័យទាក់ទងគ្នាក្នុង Microservices (RestClient, WebClient, និង FeignClient) →](../02-inter-service-communication/README.md) |
