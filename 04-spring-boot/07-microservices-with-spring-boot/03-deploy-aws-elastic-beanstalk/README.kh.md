...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../02-inter-service-communication/README.kh.md) | [មេរៀនបន្ទាប់ →](../04-microservices-sample-project/README.kh.md)
...
| :--- | :---: | :--- |
| [← ការប្រាស្រ័យទាក់ទងគ្នាក្នុង Microservices (RestClient, WebClient, និង FeignClient)](../02-inter-service-communication/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [គម្រោងគំរូ Microservices ពេញលេញ (Full Microservices Sample Project) →](../04-microservices-sample-project/README.kh.md) |
