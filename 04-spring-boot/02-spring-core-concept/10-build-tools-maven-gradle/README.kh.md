...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.kh.md) | [← មេរៀនមុន](../09-dispatcherservlet/README.kh.md) | [មេរៀនបន្ទាប់ →](../../03-spring-boot-core-features/01-spring-boot-architecture/README.kh.md)
...
| :--- | :---: | :--- |
| [← ](../09-dispatcherservlet/README.kh.md) | [📚 បញ្ជីមេរៀន Module](../README.kh.md) | [ស្ថាបត្យកម្មខាងក្នុងរបស់ Spring Boot (Spring Boot Architecture) →](../../03-spring-boot-core-features/01-spring-boot-architecture/README.kh.md) |
