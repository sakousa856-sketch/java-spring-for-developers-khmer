...
> 🧭 **រុករក:** [📚 មាតិកា Module](../README.md) | [← មេរៀនមុន](../08-spring-autowiring/README.md) | [មេរៀនបន្ទាប់ →](../10-build-tools-maven-gradle/README.md)
...
| :--- | :---: | :--- |
| [← ការប្រើប្រាស់ Autowiring ជាមួយ @Autowired](../08-spring-autowiring/README.md) | [📚 បញ្ជីមេរៀន Module](../README.md) | [ការប្រើប្រាស់ Build Tools ជាមួយ Spring (Maven & Gradle) →](../10-build-tools-maven-gradle/README.md) |
