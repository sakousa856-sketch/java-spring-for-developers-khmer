...
```mermaid
flowchart LR
    subgraph T1["កម្រិតទី ០១: Basic Java (01-basic-java)"]
        direction TB
        A1["Syntax & Ecosystem"] --> A2["Variables & Data Types"]
        A2 --> A3["Operators & Strings"] --> A4["Control Flow & Arrays"]
    end

    subgraph T2["កម្រិតទី ០២: Advance Java OOP (02-advance-java)"]
        direction TB
        B1["Classes & Objects"] --> B2["៤ សសរទ្រូងនៃ OOP"]
        B2 --> B3["Interfaces & Abstraction"] --> B4["Memory (Stack & Heap)"]
    end

    subgraph T3["កម្រិតទី ០៣: Spring Framework (03-spring-framework)"]
        direction TB
        C1["IoC Container"] --> C2["Dependency Injection"]
        C2 --> C3["Bean Scopes & Lifecycle"] --> C4["AOP & Configurations"]
    end

    subgraph T4["កម្រិតទី ០៤: Spring Boot Microservices (04-spring-boot)"]
        direction TB
...
| :---: | :--- | :--- | :---: | :---: |
| **01** | **[មូលដ្ឋានគ្រឹះ Java (Basic Java)](01-basic-java/README.kh.md)** | Syntax គ្រឹះ, Primitives, Control Flow, Loops, Arrays, Scanner | **១៨ មេរៀន (៨៧ ស្លាយ)** | [ចូលរៀនវគ្គ ០១ →](01-basic-java/README.kh.md) |
...
* 📖 **[មាតិកាមេរៀនលម្អិតកម្រិតទី ០១](01-basic-java/README.kh.md)**
* 📊 **[កាតាឡុកស្លាយបង្រៀន ៨៧ ស្លាយ](01-basic-java/slides/README.kh.md)**
...
| **11** | [ការទទួលទិន្នន័យពី Keyboard](01-basic-java/11-java-user-input/README.md) | ថ្នាក់ `java.util.Scanner`, Input methods នីមួយៗ, ដោះស្រាយបញ្ហា Newline |
| **12** | [ប្រមាណវិធីក្នុង Java](01-basic-java/12-java-operators/README.md) | ប្រមាណវិធីនព្វន្ធ, ការផ្តល់តម្លៃ, ប្រៀបធៀប, និងតក្កវិទ្យា |
| **13** | [ថ្នាក់គណិតវិទ្យា](01-basic-java/13-java-mathematic/README.md) | ថ្នាក់ `java.lang.Math` (`sqrt`, `abs`, `max`, `min`, `random`) |
...
* 📖 **[មាតិកាមេរៀនលម្អិតកម្រិតទី ០២](02-advance-java/README.kh.md)**
* 📊 **[កាតាឡុកស្លាយបង្រៀន ៨៦ ស្លាយ](02-advance-java/slides/README.kh.md)**
...
* 📖 **[មាតិកាមេរៀនលម្អិតកម្រិតទី ០៣](03-spring-framework/README.kh.md)**
* 📊 **[កាតាឡុកស្លាយបង្រៀន ៦១ ស្លាយ](03-spring-framework/slides/README.kh.md)**
...
* 📖 **[មាតិកាមេរៀន និងគម្រោងអនុវត្តជាក់ស្តែង](04-spring-boot/README.kh.md)**
