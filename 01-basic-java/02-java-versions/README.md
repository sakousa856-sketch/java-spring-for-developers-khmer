...
[![Topic](https://img.shields.io/badge/Topic-Java%20Versions-blue?style=for-the-badge)](#)
...
```mermaid
timeline
    title ដំណើរវិវត្តនៃកំណែ Java សំខាន់ៗ
    1995 : Java 1.0 (កំណើតដំបូងលើ Web)
    1997 : Java 1.1 (Swing GUI & Inner Classes)
    2000 : Java 1.3 (HotSpot JVM)
    2002 : Java 1.4 (NIO & XML Support)
    2004 : Java 1.5 / 5.0 (Generics, Annotations, Enums)
    2006 : Java 6 (Compiler API, Web Services)
```
