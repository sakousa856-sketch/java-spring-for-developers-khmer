...
[![Slides](https://img.shields.io/badge/Slide%20Deck-៨៧%20ស្លាយ-blue?style=for-the-badge)](slides/README.kh.md)
...
| **11** | **ការទទួលទិន្នន័យពី Keyboard (Scanner)** | ថ្នាក់ `java.util.Scanner`, Input methods នីមួយៗ, ដំណោះស្រាយបញ្ហា Newline | [អានមេរៀន](11-java-user-input/README.md) |
| **12** | **ប្រមាណវិធីក្នុង Java (Operators)** | ប្រមាណវិធីនព្វន្ធ, ការផ្តល់តម្លៃ, ប្រៀបធៀប, និងតក្កវិទ្យា (Logical Operators) | [អានមេរៀន](12-java-operators/README.md) |
| **13** | **ថ្នាក់គណិតវិទ្យា (Math Class)** | ថ្នាក់ `java.lang.Math` ដែលមានស្រាប់ (`max`, `min`, `sqrt`, `abs`, `random`) | [អានមេរៀន](13-java-mathematic/README.md) |
...
* 📊 **[កាតាឡុកស្លាយបង្រៀន ៨៧ ស្លាយ (87 Lecture Slides Catalog)](slides/README.kh.md)**
