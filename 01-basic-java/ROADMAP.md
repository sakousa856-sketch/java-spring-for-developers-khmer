...
* 📖 [01-basic-java (18 Lessons)](./README.md)
...
> 1. បើកមើលវីដេអូ និងមេរៀន [មេរៀនទី ១៖ ប្រវត្តិនៃ Java](./01-history-of-java/README.md)
> 2. ដំឡើង JDK 21 និង IntelliJ IDEA នៅលើកុំព្យូទ័ររបស់អ្នក
> 3. បង្កើតកម្មវិធីដំបូង `Hello World` ក្នុង [មេរៀនទី ៤](./04-first-program/README.md)
