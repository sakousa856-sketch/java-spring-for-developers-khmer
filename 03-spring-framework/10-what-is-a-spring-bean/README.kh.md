...
| :--- | :---: | :--- |
| [← Part 9: វិធីទាំង ៣ ក្នុងការកំណត់ Config ក្នុង Spring](../09-ways-to-configure-spring/README.kh.md) | [📚 មាតិកា Spring Framework](../README.kh.md) | [Part 11: របៀបកំណត់វិសាលភាព Bean Scope →](../11-how-to-define-bean-scope/README.kh.md) |
